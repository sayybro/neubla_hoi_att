...
# #from datasets.vaw_eval import VAWEvaluator
# from datasets.vaw_evaluator import Evaluator as Vaw_Evaluator
...
# #     #hoi eval
# #     if dataset_name == 'hico' or 'v-coco':
# #         for samples, targets in metric_logger.log_every(data_loader, 10, header):
...
# #         preds = np.load('pred.npy') #(31819, 620)
# #         annos = np.load(args.vaw_gts) #(31819, 620)
        
# #         evaluator = Vaw_Evaluator(
...
# #         CATEGORIES = ['all', 'head', 'medium', 'tail'] #+ list(evaluator.attribute_parent_type.keys())
# #         stats = {}
