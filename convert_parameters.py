...
def main(args):
    ...
    if args.use_vaw:
        ps['model']['obj_class_att_embed.weight'] = ps['model']['class_embed.weight'].clone()[obj_ids]
        ps['model']['obj_class_att_embed.bias'] = ps['model']['class_embed.bias'].clone()[obj_ids]
    ...
    # if args.use_vaw:
    #     l2 = nn.Linear(ps['model']['obj_class_embed.weight'].shape[1], 1)
    #     l2.to(ps['model']['obj_class_embed.weight'].device)
    #     # ps['model']['obj_class_att_embed.weight'] = torch.cat((l2.weight, ps['model']['obj_class_embed.weight'][[-1]]))
    #     # ps['model']['obj_class_att_embed.bias'] = torch.cat((l2.bias, ps['model']['obj_class_embed.bias'][[-1]]))
    #     ps['model']['obj_class_att_embed.weight'] = torch.cat((
    #         ps['model']['obj_class_embed.weight'][:-1],l2.weight, ps['model']['obj_class_embed.weight'][[-1]]))
    #     ps['model']['obj_class_att_embed.bias'] = torch.cat((
    #         ps['model']['obj_class_embed.bias'][:-1],l2.bias, ps['model']['obj_class_embed.bias'][[-1]]))
